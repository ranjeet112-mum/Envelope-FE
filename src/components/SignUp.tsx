                ...
                <div>
                    <div className="utils-signup">
                        ...
                        <form action="#" className="signupform">
                            ...
                            <button title={signUpFormValid ? "Enabled" : "Disabled"} className={"submit"} style={{ backgroundColor: signUpFormValid ? "var(--var-secondary-color)" : "grey" }} type="submit" disabled={!signUpFormValid} onClick={(e) => { e.preventDefault(); formSubmit(e); return; }}>{(signupState === "await") ? <span className={"loader"}></span> : 'Sign up'}</button>
                        </form>
                    </div>
